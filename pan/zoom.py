...
sprite_sheet = pygame.image.load('Honeyview_4.jpg')
...
while loop:
    ...
    for event in pygame.event.get():
        if event.type == pygame.QUIT:
            ...
            if event.button == 4 or event.button == 5:
                ...
                sprite_sheet = pygame.transform.scale(sprite_sheet, (6000 * int(game_state.zoom), 5000 * int(game_state.zoom)))
    ...
    # looping
    central_hyrule(int(game_state.world_offset_x) + int(world_left + world_top), int(game_state.world_offset_y))
